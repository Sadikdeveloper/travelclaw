...
export const DESTINATIONS: DestinationProfile[] = [
  {
    ...
    neighborhoods: [
      { name: 'Alfama', note: 'Hills, miradouros, and short walks if you pack light shoes.' },
      { name: 'Príncipe Real', note: 'Flatter, easier with a bag, good coffee radius.' },
      { name: 'Alcântara', note: 'LX Factory by day. Quieter if you stay off the main yard.' },
    ],
    food: ['grilled fish', 'a pastel de nata that is still warm', 'a bifana only if you are hungry'],
    transit: 'Tram 28 is a ride, not a plan. Walk the ridges and use the metro for the river.',
    packingNotes: ['cobbles punish thin soles', 'a light layer for the river wind after dark'],
    themes: [
      {
        title: 'Alfama without the loop',
        summary: 'Climb once, then stay high. Viewpoints, a church courtyard, and an early dinner.',
        places: ['Miradouro da Senhora do Monte', 'São Vicente de Fora', 'a grill in Alfama'],
      },
      {
        title: 'Chiado to the river',
        summary: 'Bookshops, a short museum, then down to the water before the cruise crowds thicken.',
        places: ['Livraria Bertrand', 'Praça do Comércio', 'Ribeira das Naus'],
      },
      {
        title: 'Belém, then stop',
        summary: 'One monastery, one pastry, one stretch of river. Do not add a third neighborhood.',
  ...
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'Downtown', note: 'Station, department-store food floors, easy rain backup.' },
      { name: 'Arashiyama', note: 'A half day. The bamboo path is short; the river is the point.' },
    ],
    food: ['tofu set near a temple', 'a kaiten sushi that is not on a poster', 'matcha only once'],
    transit: 'Buses cover the east. The subway is for crossing town. IC card from day one.',
    packingNotes: ['temple floors mean shoes come off', 'a compact umbrella lives in the bag'],
    themes: [
      {
        title: 'East side at opening',
        summary: 'One temple complex done slowly, then a lane for lunch. Leave before the tour buses settle.',
      ...
      },
      {
        ...
        summary: 'Morning river, bamboo if the path is moving, then back to town before dusk.',
        places: ['Katsura riverbank', 'bamboo grove edge', 'a station lunch'],
      },
      {
        title: 'Rain plan downtown',
        summary: 'Market, a small museum, and the station food floor. Kyoto rewards an indoor day.',
  ...
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'Centro', note: 'One morning. Altitude plus crowds. Leave by early afternoon.' },
      { name: 'Coyoacán', note: 'A separate half day, not a detour between meetings.' },
    ],
    food: ['a market comida corrida', 'tacos al pastor after 7', 'fruit from a cup, not a buffet'],
    ...
    themes: [
      {
        title: 'Roma on foot',
        summary: 'Park, a long lunch, one gallery. Let the city arrive before you cross it.',
        places: ['Parque México', 'a Roma lunch counter', 'a small gallery'],
      },
      {
        title: 'Centro, then out',
        summary: 'Zócalo and one museum. Hydrate. Do not stack Chapultepec on the same day.',
        places: ['Zócalo edge', 'a centro museum', 'a juice stand'],
      },
      {
        title: 'Coyoacán afternoon',
        summary: 'Arrive after lunch, walk the plaza, leave before the evening traffic hardens.',
    ...
    themes: [
      {
        ...
        summary: 'One church, one harbor loop, then inside. The wind decides the afternoon.',
      ...
      {
        title: 'Weather hold',
        summary: 'If the day is horizontal rain, stay in town. Do not force a ring road fantasy.',
  ...
  },
  {
    ...
    food: ['a sit-down lunch, not a standing tourist slice', 'artichokes in season', 'espresso at the bar'],
    transit: 'Walk inside the center. Metro for the Vatican and the station. Drink water from the nasoni.',
    ...
    themes: [
      ...
      {
        title: 'Vatican, early',
        summary: 'Be there at opening. Leave when you stop seeing. Prati for a quiet hour after.',
        places: ['Vatican museums or the basilica', 'Prati cafe', 'the river walk'],
      },
      {
        title: 'Trastevere after four',
        summary: 'Morning is a market or a church. Evening is the point. Book dinner or eat early.',
  ...
  },
  {
    ...
    neighborhoods: [
      { name: 'Bang Rak', note: 'River access and walkable blocks if you pick the right street.' },
    ...
    food: ['boat noodles', 'a mango sticky rice you did not plan', 'grill smoke after dark'],
    transit: 'BTS and boats beat taxis at rush hour. Temples cluster; do not cross the city twice.',
    packingNotes: ['breathable clothes', 'a scarf for temple shoulders', 'sandals that can get wet'],
    themes: [
      {
        title: 'River temples, morning only',
        summary: 'Two river sites, then out of the sun. The afternoon is a cafe with air conditioning.',
      ...
      {
        title: 'Heat protocol',
        summary: 'Museums and malls are not a failure. Bangkok in the afternoon is an indoor city.',
  ...
  },
  {
    ...
    neighborhoods: [
      { name: 'Medina', note: 'Stay near a landmark you can find at night. The lanes repeat.' },
      { name: 'Gueliz', note: 'Easier streets, useful reset day.' },
      { name: 'Palmeraie', note: 'Quiet, and a ride from everything. Only if that is the point.' },
    ],
    food: ['a slow tagine', 'orange juice you watch being pressed', 'bread from the communal oven'],
    transit: 'Walk the medina by day. Agree the taxi fare before you sit, or use a metered car in Gueliz.',
    packingNotes: ['sun layer', 'modest clothing for religious sites', 'shoes you can slip off'],
    themes: [
      {
        title: 'Medina orientation',
        summary: 'Learn one route from your door to a square. That is the whole morning.',
        places: ['Your door to Jemaa el-Fna', 'a spice stall you do not have to buy from', 'a riad lunch'],
      },
      {
        title: 'One garden',
      ...
      {
        title: 'Gueliz reset',
        summary: 'Wide streets, a gallery, a long coffee. Use this if the medina has worn you out.',
      ...
      },
      {
        ...
        places: ['Jemaa el-Fna edge', 'a seated dinner', 'the walk home you already learned'],
      },
    ],
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'Sea Point', note: 'Promenade walks. A good base if you want the ocean daily.' },
    ],
    food: ['a bakery breakfast', 'braai only if someone local is hosting', 'seafood you can see cooked'],
    transit: 'Do not assume a car-free peninsula day. The city bowl can be walked; the coast usually cannot.',
    packingNotes: ['a wind shell', 'layers, the mountain and the waterfront disagree'],
    themes: [
      {
        title: 'City and a company garden',
        summary: 'Museum or gallery, then the garden. Table Mountain only if the tablecloth is off the summit.',
      ...
      },
      {
        ...
        summary: 'Check the wind before you commit. A cancelled summit is a better day than a miserable one.',
        places: ['Lower slopes or a substitute beach', 'a viewpoint you can drive to', 'early dinner'],
      },
    ],
  },
  {
    ...
    neighborhoods: [
      { name: 'Ikseon-dong', note: 'Hanok lanes. Pretty, and small. Do not make it the whole trip.' },
      { name: 'Seongsu', note: 'Warehouses and coffee. Easy subway.' },
      { name: 'Jongno', note: 'Palaces in the morning, before the school groups.' },
    ],
    food: ['a barbecue you do not rush', 'kimbap from a real shop', 'cold noodles if the day is hot'],
    transit: 'T-money card. The subway is the plan. Palaces cluster in the north; do not recross the river twice.',
    packingNotes: ['comfortable walking shoes', 'a layer for aggressive air conditioning'],
    themes: [
      {
        title: 'One palace, done',
        summary: 'Arrive at opening. One palace is enough. The neighborhood around it is the second half.',
        places: ['A palace', 'a hanok lane', 'a noodle lunch'],
      },
      {
        title: 'Seongsu afternoon',
        summary: 'Coffee, a small shop, the stream if you want air. Skip the pop-up if the line is an hour.',
        places: ['Seongsu side street', 'a bakery', 'the stream path'],
      },
      {
        title: 'Market evening',
        summary: 'Gwangjang or a neighborhood market. Eat in courses while standing, then sit for one dish.',
      ...
      },
      {
        ...
        places: ['A river park', 'convenience-store picnic', 'back before the last interesting train'],
      },
    ],
  },
  {
    ...
    food: ['a vermut hour', 'tomato bread', 'a seafood rice you share, not a rushed paella at 7'],
    transit: 'Metro plus walking the grid. Pickpockets are a practical fact in the tourist spine, not a vibe.',
    ...
    themes: [
      ...
      },
      {
        ...
        summary: 'Book the timed entry and do not add a second mosaic. The city grid is the other half.',
        places: ['One timed modernist site', 'a long lunch', 'a rooftop only if it is free'],
      },
    ],
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'San Pedro', note: 'Market breakfasts. Go hungry, leave before you are tired.' },
    ],
    food: ['a simple soup', 'coca tea as a comfort, not a cure', 'fruit you can peel'],
    transit: 'Walk the center once you are steady. Taxis for hills on day one. Altitude is the constraint, not distance.',
    packingNotes: ['layers for sun and a cold evening', 'any personal altitude medication you already use, ask a clinician before the trip'],
    themes: [
      {
        title: 'Arrival, almost nothing',
        summary: 'Plaza, water, an early night. Ambition on day one is how people ruin day two.',
        places: ['Plaza de Armas edge', 'a light dinner', 'the hotel stairs, once'],
      },
      {
        title: 'San Pedro and a short walk',
        summary: 'Market, one museum, stop when your head says so. There is no prize for finishing.',
      ...
      },
      {
        ...
        summary: 'Sacred Valley or a ruin only after a solid night. Otherwise repeat the easy city day.',
  ...
  },
  {
    ...
    food: ['a bagel or a bao, then a real dinner', 'seafood you did not eat on a pier tour', 'coffee as a weather strategy'],
    transit: 'Compass card. Seawall is the best transit of all if the rain is light.',
    packingNotes: ['a rain shell even in July', 'layers; indoor heat and marine air disagree'],
    themes: [
      {
      ...
      },
      {
        ...
        summary: 'One museum, a long coffee, an early dinner. Vancouver rain is not a moral failure.',
  ...
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'Sultanahmet', note: 'Monuments. Sleep here only if dawn visits are the trip.' },
      { name: 'Kadıköy', note: 'The Asian side reset. Markets, fewer postcard pauses.' },
    ],
    food: ['a breakfast that takes an hour', 'fish sandwich as a ferry snack, not dinner', 'grill smoke in a side street'],
    transit: 'Istanbulkart. Ferries are part of the plan, not a novelty. Do not cross the city more than twice a day.',
    packingNotes: ['a scarf for mosques', 'shoes for steep stone', 'a layer for the ferry wind'],
    themes: [
      {
      ...
      },
      {
        ...
        summary: 'Cross the water, eat in the market, come back before you are navigating tired.',
      ...
      },
      {
        ...
        summary: 'Enter with one item in mind and a door you will use to leave. Then a neighborhood that is quiet.',
  ...
  },
  {
    ...
    neighborhoods: [
      ...
      { name: 'Ribeira', note: 'The postcard. Visit, do not necessarily sleep in the noise.' },
      { name: 'Foz', note: 'Ocean air. A tram or a taxi, then a walk.' },
    ],
    food: ['a francesinha only if you are actually hungry', 'grilled fish', 'a port tasting, not six'],
    transit: 'Walk the center. The river crossing is a bridge or a boat, once. Hills are the tax.',
    packingNotes: ['grippy shoes', 'a light rain layer most months'],
    themes: [
      {
        title: 'River once',
        summary: 'Down to the ribeira, across if you want a cellar, back up before your knees file a complaint.',
      ...
      },
      {
        ...
        summary: 'A station or a church for the tiles, then a market. Stop while you still like tiles.',
...
export function findDestination(text: string): DestinationProfile | undefined {
  ...
  const ranked = [...DESTINATIONS].sort(
    (a, b) => b.name.length - a.name.length || b.aliases.join(' ').length - a.aliases.join(' ').length,
  );
...
export function findDestinationByName(name: string): DestinationProfile | undefined {
  return findDestination(name) ?? DESTINATIONS.find((item) => item.id === name.toLowerCase());
}
